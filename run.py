...
blue_sphere2 = Sphere([100, 00, 0], 30, ambient=[0.3, 0.3, 0.7], diffuse=0.5, specular=0.3, specular_n=4)
yellow_sphere = Sphere([70, -40, 0], 30, ambient=[0.5, 0.5, 0], diffuse=0.5, specular=0.3, specular_n=4)
