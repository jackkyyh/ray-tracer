...
scene = Scene(
    ...
    objects = [
        ...
        Rect([80, -80, 30], 140, 60, [1,0,0], [0,-1,0],
            intrinsic=[0.9, 0.4, 0.2], diffuse=0.2, specular=0.9, specular_n=50),
        ...
        Sphere([85, 45, 20], 20, 
            intrinsic=[0.9, 0., 0.6], diffuse=0.1, specular=0.6, specular_n=1e2,
            refraction=0.7, refraction_index=1.25),
],
